...
use xcm_config::TrustBackedAssetsPalletLocationV5;
...
use xcm_config::{
	DotLocation, DotLocationV5, FellowshipLocation, ForeignAssetsConvertedConcreteId,
...
pub type LocalAndForeignAssets = fungibles::UnionOf<
	...
	ForeignAssets,
	LocalFromLeft<
		AssetIdForTrustBackedAssetsConvert<TrustBackedAssetsPalletLocationV5, xcm::v5::Location>,
...
pub type NativeAndAssets = fungible::UnionOf<
	...
	TargetFromLeft<DotLocationV5, xcm::v5::Location>,
	xcm::v5::Location,
	AccountId,
>;
...
impl pallet_asset_conversion::Config for Runtime {
	...
	type PoolSetupFeeAsset = DotLocationV5;
	...
	> for AssetConversionTxHelper
{
	fn create_asset_id_parameter(
		...
		let asset_id = xcm::v5::Location::new(
			1,
			[
